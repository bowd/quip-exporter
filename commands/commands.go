...
var (
	...
	RootCmd = &cobra.Command{
		Use:   "quip-exporter",
		Short: "Export quip data en-mass",
		Long:  "Service that exports quip data starting from a root folder and a set of tokens",
...
func init() {
	...
	_ = viper.BindPFlag("logging", RootCmd.Flag("logging"))
